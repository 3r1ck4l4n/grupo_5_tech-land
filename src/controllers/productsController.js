...
const productsController = {
    ...
    productDetail: (req, res)=>{  
        ...
        let item = products.find(item => item.id == req.params.id) || promotionProductsList.find(item => item.id == req.params.id);        
        res.render("productDetail", {item:item, listOfProducts: products, reviews: reviews})
    },
